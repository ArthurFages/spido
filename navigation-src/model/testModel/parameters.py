...
horizon_iteration   = 150         # nombre d'itérations à considérer dans la commande prédictive
T_discretisation    = 0.002     
...
Cf      = 122185 # rigidité de dérive du train avant
Cr      = 83130 # rigidité de dérive du train arrière
M       = 900
Iz      = 1700
a       = 1.099
b       = 1.099
