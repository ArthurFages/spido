...
trajectory  = [Output(40,40,0,0,0)] #[Output(40,5,0,0,0)] # cible
i_traj      = 0
...
horizon_iteration   = 8        # nombre d'itérations à considérer dans la commande prédictive
T_discretisation    = 0.2      # Pas de discrétisation


# == Paramètres du modèle ======================================================

Cf      = 1221.85 # rigidité de dérive du train avant
Cr      = 831.30 # rigidité de dérive du train arrière
M       = 1750
Iz      = 3000
a       = 1.1
b       = 1.6
...
obstacles   = [Obstacle(10,10),Obstacle(20,30),Obstacle(10,5),Obstacle(32,30),Obstacle(33,10)]#[Obstacle(25,5)]
...
cost_tolerance      = 1.2     # largeur du "tunnel" autour de la trajectoire de référence 
...
maneuvers   = [ Maneuver(0,0,0,0,0.5,0,0,"tout droit"),
                Maneuver(1,0,0,np.radians(45),0.5,0,0,"gauche 10 court"),
                Maneuver(2,0,0,-np.radians(45),0.5,0,0,"droite 10 court"),
                Maneuver(3,0,0,np.radians(25),0.5,0,0,"gauche 10 long"),
                Maneuver(4,0,0,-np.radians(25),0.5,0,0,"droite 10 long"),
                Maneuver(5,0,0,0,0,0,0,"gauche 20 court"),
                Maneuver(6,0,0,0,0,0,0,"droite 20 court"),
                Maneuver(7,0,0,0,0,0,0,"gauche 20 long"),
                Maneuver(8,0,0,0,0,0,0,"droite 20 long"),
                Maneuver(9,0,0,0,0,0,0,"gauche 30 court"),
                Maneuver(10,0,0,0,0,0,0,"droite 30 court"),
                Maneuver(11,0,0,0,0,0,0,"gauche 30 long"),
                Maneuver(12,0,0,0,0,0,0,"droite 30 long")]#,
...
primitive_from_file("virage_gauche_court_10",1)
primitive_from_file("virage_gauche_long_10",3)
primitive_from_file("virage_gauche_court_20",5)
primitive_from_file("virage_gauche_long_20",7)
primitive_from_file("virage_gauche_court_30",9)
primitive_from_file("virage_gauche_long_30",11)

# chargement virages à droite
primitive_from_file("virage_droite_court_10",2)
primitive_from_file("virage_droite_long_10",4)
primitive_from_file("virage_droite_court_20",6)
primitive_from_file("virage_droite_long_20",8)
primitive_from_file("virage_droite_court_30",10)
primitive_from_file("virage_droite_long_30",12)
