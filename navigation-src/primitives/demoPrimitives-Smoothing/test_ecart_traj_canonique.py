...
if __name__ == '__main__':
    ...
    # valeurs à tester
    #T_discretisation_sets   = [0.1,0.15,0.2,0.25,0.30,0.35,0.4]
    ...
    for T in T_discretisation_sets :
        ...
        for horizon in horizon_iteration_set :
            ...
            u, time = get_commands_on_horizon(T_discretisation,horizon_iteration,current_state,current_command,u_ref, x_ref, t_ref, Xref, Yref) 
                       
            times_results.append(time)
